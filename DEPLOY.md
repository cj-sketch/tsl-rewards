...
---
**ВАЖНО (с 2026-06-15):** `index.html` + `assets/` — это **билд React/HeroUI v3** (не ручной HTML).
Исходник — в POS `Business/rewards-site-heroui/`. Менять контент → править исходник, `npm run build`, скопировать `dist/*` сюда, запушить.
